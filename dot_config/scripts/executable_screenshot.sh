...
# Использование dmenu для выбора действия
action=$(echo -e "1. Скриншот всего экрана\n2. Скриншот текущего окна\n3. Скриншот выделенной области" | dmenu -p  "Выберите действие:" -nb '#080808' -nf '#e3c78a' -sb '#e3c78a' -sf '#080808')
...
# Сообщение об успешной операции (необязательно, можно убрать)
