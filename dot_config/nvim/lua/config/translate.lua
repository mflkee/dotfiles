...
local function ensure_globals()
  if not vim.g.translator_source_lang then vim.g.translator_source_lang = "auto" end
  if not vim.g.translator_target_lang then vim.g.translator_target_lang = "ru" end
  if not vim.g.translator_default_engines then vim.g.translator_default_engines = { "google", "bing" } end
end
