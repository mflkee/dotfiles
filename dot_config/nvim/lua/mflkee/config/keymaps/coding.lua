...
local function run_current_file()
  ...
  local runners = {
    ...
    python = function()
      term_exec('python ' .. shellescaped_file, dir)
    end,
    ...
    cpp = function()
      ...
      local compile_and_run = string.format('g++ -o %s %s && %s', vim.fn.shellescape(output_file), shellescaped_file, vim.fn.shellescape(output_file))
