-- Core Neovim options. Loaded first, before plugins and keymaps.
...
-- If an operation would fail due to unsaved changes in the buffer (like `:q`),
-- raise a dialog asking if you wish to save the current file(s) instead.
vim.o.confirm = true
