...
# Скрипт для обновления VPN-конфигураций с поддержкой split-конфигов
# 
...
# Параметры:
# $1 - путь к новому архиву с VPN конфигами (например, ~/Downloads/hideme_956278698472306(2).zip)

set -e  # Выход при ошибке

if [ -z "$1" ]; then
    echo "Использование: $0 <путь_к_архиву_с_vpn_конфигами>"
